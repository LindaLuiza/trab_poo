...
public class CriarHospede extends JFrame {
	...
	public CriarHospede() {
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(Alignment.TRAILING,
						gl_panel.createSequentialGroup().addContainerGap(45, Short.MAX_VALUE)
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel
				...
				.addPreferredGap(ComponentPlacement.RELATED).addComponent(Telefone, GroupLayout.PREFERRED_SIZE,
	...
	private void addHospede() {
		...
		try {
			HospedeDto hospedeDto = new HospedeDto(cpf, nome, email, telefone);
			HospedeController hospedeController = MainController.getHospedeController();
			hospedeController.createHospede(hospedeDto);
			JOptionPane.showMessageDialog(this, "Hóspede adicionado com sucesso!", "Sucesso",
