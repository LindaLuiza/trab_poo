...
public class AcomodacaoDto {
	...
	public AcomodacaoDto(int numero, int ocupacaoMax, EEstadoOcupacao estadoOcupacao, String tipo,
			double tarifaDiaria, double adicionalAcompanhante) {
	...
	public String toString() {
		return "AcomodacaoDto [numero=" + numero + ", ocupacaoMax=" + ocupacaoMax + ", estadoOcupacao=" + estadoOcupacao
				+ ", tipo=" + tipo + ", tarifaDiaria=" + tarifaDiaria + ", adicionalAcompanhante="
